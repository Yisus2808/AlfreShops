...
<body>
    ...
    <script>
        let carritoData; // Variable para almacenar los datos del carrito
                ...
                if (array.length > 0) {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            carritoData = JSON.parse(response);
                            let html = '';
                            carritoData.datos.forEach(element => {
                                html += `
                                <tr>
                                    <td>${element.id}</td>
                            ...
                            $('#total_pagar').text(carritoData.total);
            ...
            paypal.Buttons({
                ...
                onApprove: function (data, actions) {
                    return actions.order.capture().then(function (details) {
                        ...
                        window.location.href = 'http://localhost/alfre_shops/';
                    });
                }
